...
class Runner:
    ...
    def run(self, config: PPOConfig):
        ...
        role_worker_mapping = {
            ...
            # Role.RewardModel: ray.remote(FSDPWorker),
        }
        ...
        config.worker.reward.prealign_steps = int(train_dataloader.dataset.__len__()/config.data.rollout_batch_size)
        print(config.worker.reward.prealign_steps)
        # reward_model = LLM('/apdcephfs_qy3/share_301069248/users/yominyan/qwen3/Qwen3-4B-Thinking-2507/',trust_remote_code=True,tensor_parallel_size=config.worker.reward.tensor_parallel_size,dtype = 'auto',gpu_memory_utilization=0.23,max_model_len=3000)
